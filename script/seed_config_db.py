...
ANALYSES_SEED = [
    ...
    {
        'id': 'spy_cass_freight',
        'name': 'SPY vs Cass Freight Index',
        'icon': 'local_shipping',
        'short_name': 'SPY x Cass Freight',
        'description': 'S&P 500 vs Cass Freight Shipments & Expenditures indices',
        'caption': 'Cass Freight \u2022 SPY \u2022 Confirmatory Signal',
        'home_column': 1,
        'display_order': 110,
        'analysis_type': 'single',
        'target_ticker': 'SPY',
        'target_return_col': 'SPY_Returns',
        'data_file': 'spy_cass_freight_full.parquet',
        'phase_labels': None,
    },
]
...
INDICATORS_SEED = [
    ...
    # --- Cass Freight analysis (precomputed regime, dual indicator) ---
    {
        'analysis_id': 'spy_cass_freight',
        'axis': 'primary',
        'indicator_pattern': None,
        'indicator_columns': json.dumps(['CassShip_Level', 'CassShip_YoY', 'CassExp_Level', 'CassExp_YoY']),
        'indicator_filter': json.dumps({'contains': ['Cass'], 'and_contains': ['Level', 'YoY']}),
        'indicator_exclude': None,
        'trading_columns': json.dumps(['CassShip_YoY_Lagged']),
        'return_columns': json.dumps(['SPY_Returns']),
        'return_pattern': None,
        'price_column': None,
        'exclude_from_detection': None,
        'base_column': 'CassShip_YoY',
        'default_lag': -8,
        'lag_min': -18,
        'lag_max': 18,
        'regime_method': 'precomputed',
