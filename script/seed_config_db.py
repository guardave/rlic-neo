...
ANALYSES_SEED = [
    {
        ...
        'icon': 'cycle',
        'short_name': 'IC Sectors',
        'description': 'Sector performance across Investment Clock phases',
        'caption': '11 Sectors \u2022 4 Phases \u2022 Monthly Data',
        'home_column': 1,
        'display_order': 10,
        'analysis_type': 'composite',
        'target_ticker': 'SPY',
        'target_return_col': None,
        'data_file': 'monthly_with_best_phases.parquet',
        'phase_labels': json.dumps({
            "Rising+Falling": "Recovery",
            "Rising+Rising": "Overheat",
            "Falling+Rising": "Stagflation",
            "Falling+Falling": "Reflation"
        }),
    },
    {
        'id': 'spy_retailirsa',
...
INDICATORS_SEED = [
    ...
    # --- Investment Clock (composite) ---
    {
        'analysis_id': 'investment_clock',
        'axis': 'primary',
        'indicator_pattern': None,
        'indicator_columns': json.dumps(['orders_inv_ratio']),
        'indicator_filter': None,
        'indicator_exclude': None,
        'trading_columns': None,
        'return_columns': None,
        ...
        'regime_method': 'direction',
        'regime_threshold': None,
        'regime_labels': json.dumps({'rising': 'Growth Rising', 'falling': 'Growth Falling'}),
        'regime_source_col': None,
    },
    {
        'analysis_id': 'investment_clock',
        'axis': 'secondary',
        'indicator_pattern': None,
        'indicator_columns': json.dumps(['ppi_all']),
        'indicator_filter': None,
        'indicator_exclude': None,
        'trading_columns': None,
        'return_columns': None,
        ...
        'regime_method': 'direction',
        'regime_threshold': None,
        'regime_labels': json.dumps({'rising': 'Inflation Rising', 'falling': 'Inflation Falling'}),
        'regime_source_col': None,
    },
]
